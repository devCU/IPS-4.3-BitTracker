 ...
 *
 * @brief       BitTracker Categories Controller
...
class _categories extends \IPS\Node\Controller
{
	 ...
	 * @return	void
	 */
	protected function recountBitracker()
	{
		...
		try
		{
			...
			\IPS\Db::i()->update( 'bitracker_torrents', array( 'file_bitracker' => \IPS\Db::i()->select( 'COUNT(*)', 'bitracker_downloads', array( 'dfid=file_id' ) ) ), array( 'file_cat=?', $category->id ) );
