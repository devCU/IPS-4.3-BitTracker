...
class _files extends \IPS\Dispatcher\Controller
{
	...
	protected function manage()
	{
		...
		\IPS\Output::i()->title = \IPS\Member::loggedIn()->language()->addToStack('head_files_options');;
	 ...
	 */
	protected function _manageFiles()
	{
		/* Build Form */
		$form = new \IPS\Helpers\Form;
        $form->addHeader( 'general_files_settings' );
		...
		if ( $values = $form->values() )
		{
			...
			\IPS\Output::i()->redirect( \IPS\Http\Url::internal( 'app=bitracker&module=settings&controller=files' ), 'saved' );
		}
